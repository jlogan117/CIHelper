...
namespace CIHelper
{
    public static class ChangeEnvironment
    {
        ...
        {
            XmlDocument xdoc = new XmlDocument();
            xdoc.Load(@"C:\Projects\AutomatedTests\Echo.Parameters.xml");
        ...
        public static int ChangeEchoParametersXml(string pipeline, bool rotate = false, string parametersXmlPath = @"C:\Projects\AutomatedTests\Echo.Parameters.xml", string specifiedBrowser = null)
        {
        ...
        public static int ChangeEchoParametersXml(string parametersXmlPath = @"C:\Projects\AutomatedTests\Echo.Parameters.xml", string browsername = "Chrome")
        {
            try
            {
                if (browsername != null)
